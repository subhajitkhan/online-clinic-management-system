...
session_start();
  ...
  if (isset($_POST['docmsg']))
   {
    header("location:patdocmsg.php");
  }
...
<form method="POST">
  <div style="height: 100px;width: 200px;float: right;margin-right: 60px; " >
  <input style="height: 50px;width: 200px;background-color: red;color: #fff;font-size: 20px; " type="submit" name="docmsg" value="Doctor's Message">
  </div>
</form>
...
<div style="color: #09AD3D ;  ">
  <h2 id="head" style="margin-left: 230px; ">Welcome <?php echo $obj->pat_name; ?> </h2>
</div>

  <div style="background-color: #bdc3c7; width: 500px;height: 300px;margin-left:420px;">
