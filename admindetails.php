...
<div style="color: #09AD3D ;">
  <h2 id="head">Welcome <?php echo $obj->admin_name; ?> </h2>
</div>
...
<div style="background-color: #bdc3c7; width: 600px;height: 650px;margin: auto; ">
    <div style="width: 400px;height: 550px; margin-left: 25px;font-size: 21px;color: #050559; ">
  <?php 
  while ($show_data=mysql_fetch_assoc($result_admin)) {
    
    echo "<br> Admin ID :   &nbsp " .$show_data['admin_id'] ."<br>";
    echo "<br> Admin Name :  &nbsp" .$show_data['admin_name'] ."<br>";
    echo "<br> Admin Address :  &nbsp".$show_data['address']."<br>";
    echo "<br> Admin DOB : &nbsp".$show_data['dob']."<br>";
    echo "<br> Admin Phone No. :  &nbsp".$show_data['contact_no']."<br>";
    echo "<br> Admin mail :  &nbsp".$show_data['mail_id']."<br>";
    echo "<br> Admin password :".$show_data['password']."<br>";
    echo "<br> Admin Gender :&nbsp".$show_data['gender']."<br>";
    ...
    <a href="adminedit.php"><input style="margin-left: 200px;height: 40px;width: 200px;font-size: 20px; " type="button" name="edit" value="Edit Details"></a>
  </div>
