...
<div style="color: #09AD3D ;">
  <h2 id="head">Have a look on various feedback, <?php echo $obj->admin_name; ?> </h2>
</div>



<br></br>
<table style="margin-left: 20px;font-size: 15px;" width="1300"  border="1" cellpadding="1" cellspacing="1">
<tr style="background-color: #FFD104  ;color: red; ">
  ...
  while ($show_data=mysql_fetch_assoc($result)) {
    ...
    echo "<td>".$show_data['name']."</td>"; 
    echo "<td>".$show_data['phn']."</td>";
    echo "<td>".$show_data['address']."</td>";
    echo "<td>".$show_data['msg']."</td>";
    echo "<td>".$show_data['env']."</td>";
    echo "<td>".$show_data['ward']."</td>";
    echo "<td>".$show_data['doc']."</td>";
    echo "<td>".$show_data['bill']."</td>";
    echo "<td>".$show_data['enq']."</td>";
    echo "<td>".$show_data['online']."</td>";
    echo "<td>".$show_data['overall']."</td>";
