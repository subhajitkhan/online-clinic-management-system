		...
		<ul>
			...
			<li><a>Specialities <span><img src="arrow-down.jpg"></span></a>
				<ul>
					...
					<li><a href="dematology.html">Dermatology</a></li>
...
<p><br>
	<strong>ENT</strong>
	<br></br>
	The hospital boasts of highly skilled team of doctors who use latest technologies to perform endoscopic nasal surgeries, skull base surgeries, ear and cochlear implant.<br></br>
	Treatment of ear, nose and throat conditions in adults and children, along with problems in hearing and deafness, ringing in the ears, cancers of the ENT are treated.<br></br>
	The hospital makes sure to use the latest technologies in this field and keeps updating their team for the same.<br></br>
	<strong>The ears</strong><br>
 The unique domain of otolaryngologists is the treatment of ear disorders. They are trained in both the medical and surgical treatment of hearing loss, ear infections, balance disorders, ear noise (tinnitus), and some cranial nerve disorders. Otolaryngologists also manage congenital (birth) disorders of the outer and inner ear.<br></br>

<strong>The nose</strong><br>
Care of the nasal cavity and sinuses is one of the primary skills of otolaryngologists. Problems in the nasal area include allergies, smell disorders, polyps, and nasal obstruction due to a deviated septum.<br></br>

<strong>The throat</strong><br>
	...
	<div style="height: 240px;width: 100%; " ><br>
		<div style="height: 200px;width: 1200px;margin-left: 60px;  ">
			...
			<div style="height: 200px;width: 300px;float: left; ">
				...
				<p><a style="color: #fff;text-decoration: none;font-family: arial, helvetica;font-size: 15px; " href="#######">Developers</a> </p>
