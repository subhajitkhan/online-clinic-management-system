...
if(isset($_POST['search']) )
  {
    ...
    $sqlval="SELECT * FROM doc_registration where doc_name='$ami' or doc_id='$ami' or doc_dept='$ami' or doc_qualification='$ami' or status='$ami' ";
 ...
 elseif(isset($_POST['remove']) )
  {
    $del=$_POST['docid'];
    $sqldelete="DELETE  FROM doc_registration where  doc_id='$del'  ";
    $resultw=mysql_query($sqldelete);
...
<div style="color: #09AD3D ;">
  <h2 id="head">List of Our Doctors <?php echo $obj->admin_name; ?> </h2>
</div>
...
<div style="width: 200px;height: 100px;float: left;margin-left: 50px; "><br>
 <a href="approve.php"> <input style= "height: 50px;width: 190px;font-size: 15px;background-color: #D69385; " type="button" name="adddoc" value="Approve/add doctors"></a>
</div>

<form method="POST">
  <div style="height: 200px;width: 700px;background-color: #bdc3c7;float: left;margin-left: 80px; "><br>
    <label style="font-size: 20px;margin-left: 50px;color: red; ">Enter doctor Id OR doctor name OR department OR qualification OR status</label>
    <br></br><br>
...
<div style="float: left;width: 200px;height: 100px;margin-left: 50px; ">
  <a href="disadd.php"><input style= "height: 50px;width: 190px;font-size: 15px;background-color: #D69385; " type="button" name="adddoc" value="Disable doctors"></a>
</div>
...
<table style="margin: auto;font-size: 20px; " width="1200" border="1" cellpadding="1" cellspacing="1">
<tr style="background-color: #FFD104  ;color: red; ">
  ...
  while ($show_data=mysql_fetch_assoc($result_doc)) {
    ...
    echo "<td>".$show_data['doc_phn']."</td>";
    echo "<td>".$show_data['doc_mail']."</td>";
    //echo "<td>".$show_data['doc_address']."</td>";
    echo "<td>".$show_data['doc_qualification']."</td>";
    echo "<td>".$show_data['status']."</td>";
...
<form method="POST">
  <div style="height: 250px;width: 700px;background-color: #bdc3c7;margin: auto; "><br>
    <label style="font-size: 20px;margin-left: 160px;color: red; ">Enter the doctor Id that you want to delete</label>
    <br></br><br>
    ...
    <p class="sub">
      <input style="margin-left:250px;  " type="submit" name="remove" id="sub" value="Remove Doctor" >         
       </p>
